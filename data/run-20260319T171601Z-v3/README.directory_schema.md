...
`data/run-20260319T171601Z-v3/sv/global/`
...
`data/run-20260319T171601Z-v3/sv/validators/<validator_slug>/`
...
- `scan.v0.validators_validator_faucets.json` (liveness for that validator party id)
...
- `scan.v0.ans_entries_by_name.json` (only if ANS entry exists)

## 3) Index for joining
`data/run-20260319T171601Z-v3/sv/global/validators_index.jsonl`
